...
//! This documentation was generated from *Firebase Remote Config* crate version *1.0.12+20171129*, where *20171129* is the exact revision of the *firebaseremoteconfig:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/firebaseremoteconfig1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.FirebaseRemoteConfig.html) ... 
//! 
//! * projects
//!  * [*get remote config*](struct.ProjectGetRemoteConfigCall.html) and [*update remote config*](struct.ProjectUpdateRemoteConfigCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.FirebaseRemoteConfig.html)**
...
/// # }
/// ```
pub struct FirebaseRemoteConfig<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
/// 
/// * [get remote config projects](struct.ProjectGetRemoteConfigCall.html) (response)
/// * [update remote config projects](struct.ProjectUpdateRemoteConfigCall.html) (request|response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for RemoteConfig {}
impl ResponseResult for RemoteConfig {}
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    pub fn get_remote_config(&self, project: &str) -> ProjectGetRemoteConfigCall<'a, C, A> {
    ...
    /// * `project` - The GMP project identifier. Required.
    ///               See note at the beginning of this file regarding project ids.
    pub fn update_remote_config(&self, request: RemoteConfig, project: &str) -> ProjectUpdateRemoteConfigCall<'a, C, A> {
...
/// # }
/// ```
pub struct ProjectGetRemoteConfigCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> ProjectGetRemoteConfigCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, RemoteConfig)> {
    ...
    pub fn project(mut self, new_value: &str) -> ProjectGetRemoteConfigCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectGetRemoteConfigCall<'a, C, A>
                                                        where T: AsRef<str> {
...
/// # }
/// ```
pub struct ProjectUpdateRemoteConfigCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> ProjectUpdateRemoteConfigCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: RemoteConfig) -> ProjectUpdateRemoteConfigCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> ProjectUpdateRemoteConfigCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    ...
    pub fn validate_only(mut self, new_value: bool) -> ProjectUpdateRemoteConfigCall<'a, C, A> {
