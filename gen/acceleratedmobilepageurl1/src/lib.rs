...
//! This documentation was generated from *acceleratedmobilepageurl* crate version *1.0.12+20190619*, where *20190619* is the exact revision of the *acceleratedmobilepageurl:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
impl<'a, C, A> AmpUrlBatchGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> AmpUrlBatchGetCall<'a, C, A>
