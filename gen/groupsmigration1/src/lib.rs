...
//! This documentation was generated from *Groups Migration* crate version *1.0.12+20181126*, where *20181126* is the exact revision of the *groupsmigration:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
impl<'a, C, A> ArchiveInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> ArchiveInsertCall<'a, C, A>
