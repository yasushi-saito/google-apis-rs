...
//! This documentation was generated from *webfonts* crate version *1.0.12+20160302*, where *20160302* is the exact revision of the *webfonts:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.Webfonts.html) ... 
//! 
//! * [webfonts](struct.Webfont.html)
//!  * [*list*](struct.WebfontListCall.html)
//! 
//! 
//! 
//! 
