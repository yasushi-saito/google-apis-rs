...
//! This documentation was generated from *Service Broker* crate version *1.0.12+20190624*, where *20190624* is the exact revision of the *servicebroker:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! # Features
//! 
//! Use the following functionality with ease from the central [hub](struct.ServiceBroker.html) ... 
//! 
//! 
...
/// Central instance to access all ServiceBroker related resource activities
///
/// # Examples
///
...
impl<'a, C, A> Hub for ServiceBroker<C, A> {}

impl<'a, C, A> ServiceBroker<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> ServiceBroker<C, A> {
        ServiceBroker {
    ...
    /// It defaults to `https://servicebroker.googleapis.com/`.
    ///
...
/// It is not used directly, but through the `ServiceBroker` hub.
///
/// # Example
///
...
impl<'a, C, A> MethodMethods<'a, C, A> {
    ...
    pub fn test_iam_permissions(&self, request: GoogleIamV1__TestIamPermissionsRequest, resource: &str) -> MethodTestIamPermissionCall<'a, C, A> {
    ...
    ///                See the operation documentation for the appropriate value for this field.
    pub fn set_iam_policy(&self, request: GoogleIamV1__SetIamPolicyRequest, resource: &str) -> MethodSetIamPolicyCall<'a, C, A> {
    ...
    ///                See the operation documentation for the appropriate value for this field.
    pub fn get_iam_policy(&self, resource: &str) -> MethodGetIamPolicyCall<'a, C, A> {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_servicebroker1 as servicebroker1;
/// use servicebroker1::GoogleIamV1__TestIamPermissionsRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use servicebroker1::ServiceBroker;
...
impl<'a, C, A> MethodTestIamPermissionCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleIamV1__TestIamPermissionsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "servicebroker.testIamPermissions",
    ...
    pub fn request(mut self, new_value: GoogleIamV1__TestIamPermissionsRequest) -> MethodTestIamPermissionCall<'a, C, A> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> MethodTestIamPermissionCall<'a, C, A>
...
impl<'a, C, A> MethodSetIamPolicyCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleIamV1__Policy)> {
        ...
        dlg.begin(MethodInfo { id: "servicebroker.setIamPolicy",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("resource", self._resource.to_string()));
        for &field in ["alt", "resource"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleIamV1__SetIamPolicyRequest) -> MethodSetIamPolicyCall<'a, C, A> {
        self._request = new_value;
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> MethodSetIamPolicyCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.methods().get_iam_policy("resource")
///              .doit();
/// # }
/// ```
...
impl<'a, C, A> MethodGetIamPolicyCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleIamV1__Policy)> {
        ...
        dlg.begin(MethodInfo { id: "servicebroker.getIamPolicy",
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> MethodGetIamPolicyCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
