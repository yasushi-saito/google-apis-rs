...
//! This documentation was generated from *Abusive Experience Report* crate version *1.0.12+20190624*, where *20190624* is the exact revision of the *abusiveexperiencereport:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/abusiveexperiencereport1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.AbusiveExperienceReport.html) ... 
//! 
//! * sites
//!  * [*get*](struct.SiteGetCall.html)
//! * violating sites
//!  * [*list*](struct.ViolatingSiteListCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.AbusiveExperienceReport.html)**
...
/// # }
/// ```
pub struct AbusiveExperienceReport<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
impl<'a, C, A> Hub for AbusiveExperienceReport<C, A> {}

impl<'a, C, A> AbusiveExperienceReport<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> AbusiveExperienceReport<C, A> {
    ...
    pub fn violating_sites(&'a self) -> ViolatingSiteMethods<'a, C, A> {
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [list violating sites](struct.ViolatingSiteListCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for ViolatingSitesResponse {}
...
pub struct SiteMethods<'a, C, A>
    ...
    hub: &'a AbusiveExperienceReport<C, A>,
}
...
/// # }
/// ```
pub struct ViolatingSiteMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a AbusiveExperienceReport<C, A>,
}

impl<'a, C, A> MethodsBuilder for ViolatingSiteMethods<'a, C, A> {}

impl<'a, C, A> ViolatingSiteMethods<'a, C, A> {
...
impl<'a, C, A> SiteGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, SiteSummaryResponse)> {
        ...
        dlg.begin(MethodInfo { id: "abusiveexperiencereport.sites.get",
    ...
    pub fn name(mut self, new_value: &str) -> SiteGetCall<'a, C, A> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> SiteGetCall<'a, C, A>
...
/// # }
/// ```
pub struct ViolatingSiteListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> ViolatingSiteListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, ViolatingSitesResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        let mut dlg: &mut Delegate = match self._delegate {
        ...
        dlg.begin(MethodInfo { id: "abusiveexperiencereport.violatingSites.list",
                               http_method: hyper::method::Method::Get });
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ViolatingSiteListCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ViolatingSiteListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
