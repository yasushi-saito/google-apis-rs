...
//! This documentation was generated from *Cloud Video Intelligence* crate version *1.0.12+20190626*, where *20190626* is the exact revision of the *videointelligence:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/videointelligence1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.CloudVideoIntelligence.html) ... 
//! 
//! * operations
//!  * [*cancel*](struct.OperationCancelCall.html), [*delete*](struct.OperationDeleteCall.html), [*get*](struct.OperationGetCall.html), [*projects locations operations cancel*](struct.OperationProjectLocationOperationCancelCall.html), [*projects locations operations delete*](struct.OperationProjectLocationOperationDeleteCall.html) and [*projects locations operations get*](struct.OperationProjectLocationOperationGetCall.html)
//! * projects
...
//! 
//! * **[Hub](struct.CloudVideoIntelligence.html)**
...
/// # }
/// ```
pub struct CloudVideoIntelligence<C, A> {
    client: RefCell<C>,
    auth: RefCell<A>,
    _user_agent: String,
    _base_url: String,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [annotate videos](struct.VideoAnnotateCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl Part for GoogleCloudVideointelligenceV1_ObjectTrackingConfig {}
...
/// // like `cancel(...)`, `delete(...)`, `get(...)`, `projects_locations_operations_cancel(...)`, `projects_locations_operations_delete(...)` and `projects_locations_operations_get(...)`
...
impl<'a, C, A> OperationMethods<'a, C, A> {
    ...
    pub fn projects_locations_operations_get(&self, name: &str) -> OperationProjectLocationOperationGetCall<'a, C, A> {
    ...
    pub fn projects_locations_operations_cancel(&self, name: &str) -> OperationProjectLocationOperationCancelCall<'a, C, A> {
    ...
    ///
    /// * `name` - The name of the operation resource to be deleted.
    pub fn projects_locations_operations_delete(&self, name: &str) -> OperationProjectLocationOperationDeleteCall<'a, C, A> {
...
impl<'a, C, A> VideoMethods<'a, C, A> {
    ...
    pub fn annotate(&self, request: GoogleCloudVideointelligenceV1_AnnotateVideoRequest) -> VideoAnnotateCall<'a, C, A> {
        VideoAnnotateCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    /// * `request` - No description provided.
    /// * `name` - The name of the operation resource to be cancelled.
    pub fn locations_operations_cancel(&self, request: GoogleLongrunning_CancelOperationRequest, name: &str) -> ProjectLocationOperationCancelCall<'a, C, A> {
...
/// # }
/// ```
pub struct OperationProjectLocationOperationGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for OperationProjectLocationOperationGetCall<'a, C, A> {}

impl<'a, C, A> OperationProjectLocationOperationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.projects.locations.operations.get",
    ...
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationGetCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> OperationProjectLocationOperationGetCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> OperationProjectLocationOperationGetCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> OperationProjectLocationOperationGetCall<'a, C, A>
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> OperationProjectLocationOperationGetCall<'a, C, A>
...
impl<'a, C, A> OperationDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.delete",
...
/// # }
/// ```
pub struct OperationProjectLocationOperationCancelCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for OperationProjectLocationOperationCancelCall<'a, C, A> {}

impl<'a, C, A> OperationProjectLocationOperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.projects.locations.operations.cancel",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationCancelCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> OperationProjectLocationOperationCancelCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> OperationProjectLocationOperationCancelCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> OperationProjectLocationOperationCancelCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> OperationProjectLocationOperationCancelCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct OperationProjectLocationOperationDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for OperationProjectLocationOperationDeleteCall<'a, C, A> {}

impl<'a, C, A> OperationProjectLocationOperationDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.projects.locations.operations.delete",
                               http_method: hyper::method::Method::Delete });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationDeleteCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> OperationProjectLocationOperationDeleteCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> OperationProjectLocationOperationDeleteCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> OperationProjectLocationOperationDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> OperationProjectLocationOperationDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> OperationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.get",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a, C, A> OperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.operations.cancel",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// # }
/// ```
pub struct VideoAnnotateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> VideoAnnotateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.videos.annotate",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudVideointelligenceV1_AnnotateVideoRequest) -> VideoAnnotateCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> VideoAnnotateCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> VideoAnnotateCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> ProjectLocationOperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.projects.locations.operations.cancel",
                               http_method: hyper::method::Method::Post });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleLongrunning_CancelOperationRequest) -> ProjectLocationOperationCancelCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// The name of the operation resource to be cancelled.
...
impl<'a, C, A> ProjectLocationOperationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.projects.locations.operations.get",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a, C, A> ProjectLocationOperationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleLongrunning_ListOperationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        ...
        dlg.begin(MethodInfo { id: "videointelligence.projects.locations.operations.list",
                               http_method: hyper::method::Method::Get });
...
impl<'a, C, A> ProjectLocationOperationDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(MethodInfo { id: "videointelligence.projects.locations.operations.delete",
                               http_method: hyper::method::Method::Delete });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
