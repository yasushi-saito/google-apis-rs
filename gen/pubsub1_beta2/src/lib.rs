...
//! This documentation was generated from *Pubsub* crate version *1.0.12+20190625*, where *20190625* is the exact revision of the *pubsub:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_pubsub1_beta2 as pubsub1_beta2;
/// use pubsub1_beta2::SetIamPolicyRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use pubsub1_beta2::Pubsub;
