...
//! This documentation was generated from *digitalassetlinks* crate version *1.0.12+20190619*, where *20190619* is the exact revision of the *digitalassetlinks:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
impl<'a, C, A> AssetlinkCheckCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> AssetlinkCheckCall<'a, C, A> {
...
impl<'a, C, A> StatementListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> StatementListCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
