...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/datastore1_beta3).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.Datastore.html) ... 
//! 
//! * projects
//!  * [*allocate ids*](struct.ProjectAllocateIdCall.html), [*begin transaction*](struct.ProjectBeginTransactionCall.html), [*commit*](struct.ProjectCommitCall.html), [*lookup*](struct.ProjectLookupCall.html), [*reserve ids*](struct.ProjectReserveIdCall.html), [*rollback*](struct.ProjectRollbackCall.html) and [*run query*](struct.ProjectRunQueryCall.html)
//! 
//! 
//! 
//! 
...
/// // like `allocate_ids(...)`, `begin_transaction(...)`, `commit(...)`, `lookup(...)`, `reserve_ids(...)`, `rollback(...)` and `run_query(...)`
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::ReserveIdsRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::LookupRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::CommitRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::AllocateIdsRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::RollbackRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_datastore1_beta3 as datastore1_beta3;
/// use datastore1_beta3::BeginTransactionRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use datastore1_beta3::Datastore;
