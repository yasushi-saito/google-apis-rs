...
//! This documentation was generated from *Cloud Run* crate version *1.0.12+20190624*, where *20190624* is the exact revision of the *run:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! 
//! * projects
//!  * [*locations get*](struct.ProjectLocationGetCall.html)
//! 
//! 
//! 
//! 
...
impl<'a, C, A> ProjectLocationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Location)> {
        ...
        dlg.begin(MethodInfo { id: "run.projects.locations.get",
