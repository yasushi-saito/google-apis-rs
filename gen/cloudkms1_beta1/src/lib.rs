...
//! This documentation was generated from *Cloud KMS* crate version *1.0.12+20170515*, where *20170515* is the exact revision of the *cloudkms:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
