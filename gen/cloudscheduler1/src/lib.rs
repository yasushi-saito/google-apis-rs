...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/cloudscheduler1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.CloudScheduler.html) ... 
//! 
//! * projects
//!  * [*locations get*](struct.ProjectLocationGetCall.html), [*locations jobs create*](struct.ProjectLocationJobCreateCall.html), [*locations jobs delete*](struct.ProjectLocationJobDeleteCall.html), [*locations jobs get*](struct.ProjectLocationJobGetCall.html), [*locations jobs list*](struct.ProjectLocationJobListCall.html), [*locations jobs patch*](struct.ProjectLocationJobPatchCall.html), [*locations jobs pause*](struct.ProjectLocationJobPauseCall.html), [*locations jobs resume*](struct.ProjectLocationJobResumeCall.html), [*locations jobs run*](struct.ProjectLocationJobRunCall.html) and [*locations list*](struct.ProjectLocationListCall.html)
//! 
//! 
//! 
//! 
...
//! 
//! * **[Hub](struct.CloudScheduler.html)**
...
impl<'a, C, A> Hub for CloudScheduler<C, A> {}

impl<'a, C, A> CloudScheduler<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> CloudScheduler<C, A> {
        CloudScheduler {
...
/// 
/// * [locations jobs list projects](struct.ProjectLocationJobListCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations jobs delete projects](struct.ProjectLocationJobDeleteCall.html) (response)
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations jobs resume projects](struct.ProjectLocationJobResumeCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct ResumeJobRequest { _never_set: Option<bool> }

impl RequestValue for ResumeJobRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations jobs pause projects](struct.ProjectLocationJobPauseCall.html) (response)
/// * [locations jobs get projects](struct.ProjectLocationJobGetCall.html) (response)
/// * [locations jobs create projects](struct.ProjectLocationJobCreateCall.html) (request|response)
/// * [locations jobs resume projects](struct.ProjectLocationJobResumeCall.html) (response)
/// * [locations jobs run projects](struct.ProjectLocationJobRunCall.html) (response)
/// * [locations jobs patch projects](struct.ProjectLocationJobPatchCall.html) (request|response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct Job {
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations jobs pause projects](struct.ProjectLocationJobPauseCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct PauseJobRequest { _never_set: Option<bool> }

impl RequestValue for PauseJobRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations jobs run projects](struct.ProjectLocationJobRunCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct RunJobRequest { _never_set: Option<bool> }

impl RequestValue for RunJobRequest {}
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    ///            * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]),
    ///               hyphens (-), or underscores (_). The maximum length is 500 characters.
    pub fn locations_jobs_patch(&self, request: Job, name: &str) -> ProjectLocationJobPatchCall<'a, C, A> {
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_cloudscheduler1 as cloudscheduler1;
/// use cloudscheduler1::PauseJobRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use cloudscheduler1::CloudScheduler;
...
/// # }
/// ```
pub struct ProjectLocationJobPauseCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobPauseCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobPauseCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.pause",
    ...
    pub fn request(mut self, new_value: PauseJobRequest) -> ProjectLocationJobPauseCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobPauseCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobPauseCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobPauseCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobPauseCall<'a, C, A>
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobPauseCall<'a, C, A>
...
/// # }
/// ```
pub struct ProjectLocationJobDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobDeleteCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.delete",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobDeleteCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobDeleteCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobDeleteCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct ProjectLocationJobGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobGetCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.get",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobGetCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobGetCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobGetCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct ProjectLocationJobCreateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobCreateCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobCreateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.create",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Job) -> ProjectLocationJobCreateCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Required.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationJobCreateCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobCreateCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobCreateCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobCreateCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobCreateCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct ProjectLocationJobListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobListCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListJobsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.list",
                               http_method: hyper::method::Method::Get });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationJobListCall<'a, C, A> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationJobListCall<'a, C, A> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationJobListCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobListCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobListCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_cloudscheduler1 as cloudscheduler1;
/// use cloudscheduler1::ResumeJobRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use cloudscheduler1::CloudScheduler;
...
/// # }
/// ```
pub struct ProjectLocationJobResumeCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobResumeCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobResumeCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.resume",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ResumeJobRequest) -> ProjectLocationJobResumeCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Required.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobResumeCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobResumeCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobResumeCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobResumeCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobResumeCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_cloudscheduler1 as cloudscheduler1;
/// use cloudscheduler1::RunJobRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use cloudscheduler1::CloudScheduler;
...
/// # }
/// ```
pub struct ProjectLocationJobRunCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobRunCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobRunCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.run",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: RunJobRequest) -> ProjectLocationJobRunCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Required.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobRunCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobRunCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobRunCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobRunCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobRunCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> ProjectLocationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Location)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.get",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a, C, A> ProjectLocationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListLocationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.list",
                               http_method: hyper::method::Method::Get });
...
/// # }
/// ```
pub struct ProjectLocationJobPatchCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for ProjectLocationJobPatchCall<'a, C, A> {}

impl<'a, C, A> ProjectLocationJobPatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Job)> {
        ...
        dlg.begin(MethodInfo { id: "cloudscheduler.projects.locations.jobs.patch",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Job) -> ProjectLocationJobPatchCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Optionally caller-specified in CreateJob, after
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobPatchCall<'a, C, A> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn update_mask(mut self, new_value: &str) -> ProjectLocationJobPatchCall<'a, C, A> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> ProjectLocationJobPatchCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobPatchCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> ProjectLocationJobPatchCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationJobPatchCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
