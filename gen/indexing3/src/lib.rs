...
//! This documentation was generated from *Indexing* crate version *1.0.12+20190627*, where *20190627* is the exact revision of the *indexing:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/indexing3).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.Indexing.html) ... 
//! 
//! * [url notifications](struct.UrlNotification.html)
//!  * [*get metadata*](struct.UrlNotificationGetMetadataCall.html) and [*publish*](struct.UrlNotificationPublishCall.html)
//! 
//! 
//! 
//! 
...
impl<'a, C, A> Hub for Indexing<C, A> {}

impl<'a, C, A> Indexing<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> Indexing<C, A> {
        Indexing {
    ...
    pub fn url_notifications(&'a self) -> UrlNotificationMethods<'a, C, A> {
...
/// 
/// * [publish url notifications](struct.UrlNotificationPublishCall.html) (request)
/// * [get metadata url notifications](struct.UrlNotificationGetMetadataCall.html) (none)
/// 
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [get metadata url notifications](struct.UrlNotificationGetMetadataCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [publish url notifications](struct.UrlNotificationPublishCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for PublishUrlNotificationResponse {}
...
/// # }
/// ```
pub struct UrlNotificationMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a Indexing<C, A>,
}

impl<'a, C, A> MethodsBuilder for UrlNotificationMethods<'a, C, A> {}

impl<'a, C, A> UrlNotificationMethods<'a, C, A> {
    ...
    pub fn publish(&self, request: UrlNotification) -> UrlNotificationPublishCall<'a, C, A> {
    ...
    pub fn get_metadata(&self) -> UrlNotificationGetMetadataCall<'a, C, A> {
...
/// # }
/// ```
pub struct UrlNotificationPublishCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for UrlNotificationPublishCall<'a, C, A> {}

impl<'a, C, A> UrlNotificationPublishCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, PublishUrlNotificationResponse)> {
        ...
        dlg.begin(MethodInfo { id: "indexing.urlNotifications.publish",
    ...
    pub fn request(mut self, new_value: UrlNotification) -> UrlNotificationPublishCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> UrlNotificationPublishCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> UrlNotificationPublishCall<'a, C, A>
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> UrlNotificationPublishCall<'a, C, A>
...
/// # }
/// ```
pub struct UrlNotificationGetMetadataCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for UrlNotificationGetMetadataCall<'a, C, A> {}

impl<'a, C, A> UrlNotificationGetMetadataCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, UrlNotificationMetadata)> {
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        let mut dlg: &mut Delegate = match self._delegate {
        ...
        dlg.begin(MethodInfo { id: "indexing.urlNotifications.getMetadata",
    ...
    pub fn url(mut self, new_value: &str) -> UrlNotificationGetMetadataCall<'a, C, A> {
    ...
    /// * *alt* (query-string) - Data format for response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> UrlNotificationGetMetadataCall<'a, C, A>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> UrlNotificationGetMetadataCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> UrlNotificationGetMetadataCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
