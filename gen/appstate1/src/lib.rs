...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.AppState.html) ... 
//! 
//! * states
//!  * [*clear*](struct.StateClearCall.html), [*delete*](struct.StateDeleteCall.html), [*get*](struct.StateGetCall.html), [*list*](struct.StateListCall.html) and [*update*](struct.StateUpdateCall.html)
//! 
//! 
//! 
//! 
...
//! // Values shown here are possibly random and not representative !
//! let result = hub.states().update(req, -65)
//!              .current_state_version("sed")
//!              .doit();
//! 
//! match result {
//!     Err(e) => match e {
...
impl AsRef<str> for Scope {
    fn as_ref(&self) -> &str {
        match *self {
            Scope::Full => "https://www.googleapis.com/auth/appstate",
        }
    }
}
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.states().update(req, -85)
///              .current_state_version("dolores")
///              .doit();
/// 
/// match result {
///     Err(e) => match e {
...
impl<'a, C, A> AppState<C, A>
    ...
    /// It defaults to `https://www.googleapis.com/appstate/v1/`.
    ///
...
/// 
/// * [list states](struct.StateListCall.html) (response)
/// 
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [get states](struct.StateGetCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [update states](struct.StateUpdateCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for UpdateRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [clear states](struct.StateClearCall.html) (response)
/// * [update states](struct.StateUpdateCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl<'a, C, A> StateDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<hyper::client::Response> {
        ...
        let mut url = self.hub._base_url.clone() + "states/{stateKey}";
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> StateDeleteCall<'a, C, A>
...
impl<'a, C, A> StateGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> StateGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> StateClearCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, WriteResult)> {
        ...
        let mut url = self.hub._base_url.clone() + "states/{stateKey}/clear";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::Full.as_ref().to_string(), ());
        }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> StateClearCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> StateListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "states";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::Full.as_ref().to_string(), ());
        }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> StateListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> StateUpdateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> StateUpdateCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
