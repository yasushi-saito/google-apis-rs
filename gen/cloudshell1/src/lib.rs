...
//! This documentation was generated from *Cloud Shell* crate version *1.0.12+20190701*, where *20190701* is the exact revision of the *cloudshell:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.CloudShell.html) ... 
//! 
...
impl<'a, C, A> Hub for CloudShell<C, A> {}

impl<'a, C, A> CloudShell<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> CloudShell<C, A> {
        CloudShell {
...
impl<'a, C, A> OperationDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "cloudshell.operations.delete",
...
impl<'a, C, A> OperationGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "cloudshell.operations.get",
...
impl<'a, C, A> OperationListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListOperationsResponse)> {
        ...
        dlg.begin(MethodInfo { id: "cloudshell.operations.list",
                               http_method: hyper::method::Method::Get });
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_cloudshell1 as cloudshell1;
/// use cloudshell1::CancelOperationRequest;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use cloudshell1::CloudShell;
...
impl<'a, C, A> OperationCancelCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Empty)> {
        ...
        dlg.begin(MethodInfo { id: "cloudshell.operations.cancel",
