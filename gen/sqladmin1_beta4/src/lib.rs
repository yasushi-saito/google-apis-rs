...
impl Part for DiskEncryptionConfiguration {}
...
/// 
/// * [delete backup runs](struct.BackupRunDeleteCall.html) (none)
/// * [get backup runs](struct.BackupRunGetCall.html) (response)
/// * [insert backup runs](struct.BackupRunInsertCall.html) (request)
...
impl Part for DiskEncryptionStatus {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [rotate server ca instances](struct.InstanceRotateServerCaCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for InstancesRotateServerCaRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [list server cas instances](struct.InstanceListServerCaCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl ResponseResult for InstancesListServerCasResponse {}
...
impl NestedType for ExportContextSqlExportOptionsMysqlExportOptions {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [failover instances](struct.InstanceFailoverCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for InstancesFailoverRequest {}
...
/// * [create ephemeral ssl certs](struct.SslCertCreateEphemeralCall.html) (response)
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [create ephemeral ssl certs](struct.SslCertCreateEphemeralCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl<'a, C, A> OperationMethods<'a, C, A> {
    ...
    pub fn get(&self, project: &str, operation: &str) -> OperationGetCall<'a, C, A> {
        OperationGetCall {
            hub: self.hub,
            _project: project.to_string(),
...
/// # }
/// ```
pub struct TierMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a SQLAdmin<C, A>,
}

impl<'a, C, A> MethodsBuilder for TierMethods<'a, C, A> {}

impl<'a, C, A> TierMethods<'a, C, A> {
    ...
    pub fn list(&self, project: &str) -> TierListCall<'a, C, A> {
        TierListCall {
            hub: self.hub,
            _project: project.to_string(),
            _delegate: Default::default(),
...
impl<'a, C, A> UserMethods<'a, C, A> {
    ...
    pub fn list(&self, project: &str, instance: &str) -> UserListCall<'a, C, A> {
        UserListCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Database instance ID. This does not include the project ID.
    pub fn insert(&self, request: User, project: &str, instance: &str) -> UserInsertCall<'a, C, A> {
        UserInsertCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
...
impl<'a, C, A> InstanceMethods<'a, C, A> {
    ...
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn failover(&self, request: InstancesFailoverRequest, project: &str, instance: &str) -> InstanceFailoverCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn import(&self, request: InstancesImportRequest, project: &str, instance: &str) -> InstanceImportCall<'a, C, A> {
        InstanceImportCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn reset_ssl_config(&self, project: &str, instance: &str) -> InstanceResetSslConfigCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn add_server_ca(&self, project: &str, instance: &str) -> InstanceAddServerCaCall<'a, C, A> {
    ...
    pub fn promote_replica(&self, project: &str, instance: &str) -> InstancePromoteReplicaCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Database instance ID. This does not include the project ID.
    pub fn get(&self, project: &str, instance: &str) -> InstanceGetCall<'a, C, A> {
        InstanceGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn patch(&self, request: DatabaseInstance, project: &str, instance: &str) -> InstancePatchCall<'a, C, A> {
        InstancePatchCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn delete(&self, project: &str, instance: &str) -> InstanceDeleteCall<'a, C, A> {
        InstanceDeleteCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - ID of the project that contains the read replica.
    /// * `instance` - Cloud SQL read replica instance name.
    pub fn stop_replica(&self, project: &str, instance: &str) -> InstanceStopReplicaCall<'a, C, A> {
    ...
    /// * `project` - ID of the project that contains the read replica.
    /// * `instance` - Cloud SQL read replica instance name.
    pub fn start_replica(&self, project: &str, instance: &str) -> InstanceStartReplicaCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn rotate_server_ca(&self, request: InstancesRotateServerCaRequest, project: &str, instance: &str) -> InstanceRotateServerCaCall<'a, C, A> {
    ...
    pub fn list(&self, project: &str) -> InstanceListCall<'a, C, A> {
        InstanceListCall {
            hub: self.hub,
            _project: project.to_string(),
            _page_token: Default::default(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn list_server_cas(&self, project: &str, instance: &str) -> InstanceListServerCaCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn update(&self, request: DatabaseInstance, project: &str, instance: &str) -> InstanceUpdateCall<'a, C, A> {
        InstanceUpdateCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn restart(&self, project: &str, instance: &str) -> InstanceRestartCall<'a, C, A> {
        InstanceRestartCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn export(&self, request: InstancesExportRequest, project: &str, instance: &str) -> InstanceExportCall<'a, C, A> {
        InstanceExportCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn restore_backup(&self, request: InstancesRestoreBackupRequest, project: &str, instance: &str) -> InstanceRestoreBackupCall<'a, C, A> {
...
/// # }
/// ```
pub struct FlagMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a SQLAdmin<C, A>,
}

impl<'a, C, A> MethodsBuilder for FlagMethods<'a, C, A> {}

impl<'a, C, A> FlagMethods<'a, C, A> {
...
/// # }
/// ```
pub struct DatabaseMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a SQLAdmin<C, A>,
}

impl<'a, C, A> MethodsBuilder for DatabaseMethods<'a, C, A> {}

impl<'a, C, A> DatabaseMethods<'a, C, A> {
    ...
    pub fn delete(&self, project: &str, instance: &str, database: &str) -> DatabaseDeleteCall<'a, C, A> {
        DatabaseDeleteCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    pub fn patch(&self, request: Database, project: &str, instance: &str, database: &str) -> DatabasePatchCall<'a, C, A> {
        DatabasePatchCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn list(&self, project: &str, instance: &str) -> DatabaseListCall<'a, C, A> {
        DatabaseListCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Database instance ID. This does not include the project ID.
    pub fn insert(&self, request: Database, project: &str, instance: &str) -> DatabaseInsertCall<'a, C, A> {
        DatabaseInsertCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    pub fn get(&self, project: &str, instance: &str, database: &str) -> DatabaseGetCall<'a, C, A> {
        DatabaseGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `instance` - Database instance ID. This does not include the project ID.
    /// * `database` - Name of the database to be updated in the instance.
    pub fn update(&self, request: Database, project: &str, instance: &str, database: &str) -> DatabaseUpdateCall<'a, C, A> {
        DatabaseUpdateCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
...
/// # }
/// ```
pub struct SslCertMethods<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> SslCertMethods<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn insert(&self, request: SslCertsInsertRequest, project: &str, instance: &str) -> SslCertInsertCall<'a, C, A> {
        SslCertInsertCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
    ...
    pub fn delete(&self, project: &str, instance: &str, sha1_fingerprint: &str) -> SslCertDeleteCall<'a, C, A> {
        SslCertDeleteCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    /// * `sha1Fingerprint` - Sha1 FingerPrint.
    pub fn get(&self, project: &str, instance: &str, sha1_fingerprint: &str) -> SslCertGetCall<'a, C, A> {
        SslCertGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - Project ID of the Cloud SQL project.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn create_ephemeral(&self, request: SslCertsCreateEphemeralRequest, project: &str, instance: &str) -> SslCertCreateEphemeralCall<'a, C, A> {
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn list(&self, project: &str, instance: &str) -> SslCertListCall<'a, C, A> {
        SslCertListCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
...
/// # }
/// ```
pub struct BackupRunMethods<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> BackupRunMethods<'a, C, A> {
    ...
    pub fn get(&self, project: &str, instance: &str, id: &str) -> BackupRunGetCall<'a, C, A> {
        BackupRunGetCall {
            hub: self.hub,
            _project: project.to_string(),
            _instance: instance.to_string(),
    ...
    /// * `project` - Project ID of the project that contains the instance.
    /// * `instance` - Cloud SQL instance ID. This does not include the project ID.
    pub fn insert(&self, request: BackupRun, project: &str, instance: &str) -> BackupRunInsertCall<'a, C, A> {
        BackupRunInsertCall {
            hub: self.hub,
            _request: request,
            _project: project.to_string(),
...
impl<'a, C, A> CallBuilder for TierListCall<'a, C, A> {}

impl<'a, C, A> TierListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> TierListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> TierListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> UserListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> UserListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> UserDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> UserDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> UserUpdateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> UserUpdateCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
impl<'a, C, A> UserInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> UserInsertCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
/// # }
/// ```
pub struct InstanceTruncateLogCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceTruncateLogCall<'a, C, A> {}

impl<'a, C, A> InstanceTruncateLogCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.instances.truncateLog",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> InstanceTruncateLogCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> InstanceTruncateLogCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceTruncateLogCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceTruncateLogCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> InstanceDemoteMasterCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceDemoteMasterCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
...
/// # }
/// ```
pub struct InstanceFailoverCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceFailoverCall<'a, C, A> {}

impl<'a, C, A> InstanceFailoverCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.instances.failover",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: InstancesFailoverRequest) -> InstanceFailoverCall<'a, C, A> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> InstanceFailoverCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> InstanceFailoverCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> InstanceFailoverCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceFailoverCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceFailoverCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceImportCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceImportCall<'a, C, A> {}

impl<'a, C, A> InstanceImportCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceImportCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceImportCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceResetSslConfigCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceResetSslConfigCall<'a, C, A> {}

impl<'a, C, A> InstanceResetSslConfigCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceResetSslConfigCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceResetSslConfigCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceAddServerCaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceAddServerCaCall<'a, C, A> {}

impl<'a, C, A> InstanceAddServerCaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.instances.addServerCa",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> InstanceAddServerCaCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> InstanceAddServerCaCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> InstanceAddServerCaCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceAddServerCaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceAddServerCaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstancePromoteReplicaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstancePromoteReplicaCall<'a, C, A> {}

impl<'a, C, A> InstancePromoteReplicaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstancePromoteReplicaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstancePromoteReplicaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> InstanceGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstancePatchCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstancePatchCall<'a, C, A> {}

impl<'a, C, A> InstancePatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstancePatchCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstancePatchCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceCloneCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceCloneCall<'a, C, A> {}

impl<'a, C, A> InstanceCloneCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceCloneCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceCloneCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> InstanceDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceStopReplicaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceStopReplicaCall<'a, C, A> {}

impl<'a, C, A> InstanceStopReplicaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceStopReplicaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceStopReplicaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceStartReplicaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceStartReplicaCall<'a, C, A> {}

impl<'a, C, A> InstanceStartReplicaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceStartReplicaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceStartReplicaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> InstanceInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceInsertCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceInsertCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceRotateServerCaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceRotateServerCaCall<'a, C, A> {}

impl<'a, C, A> InstanceRotateServerCaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.instances.rotateServerCa",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: InstancesRotateServerCaRequest) -> InstanceRotateServerCaCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Project ID of the project that contains the instance.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> InstanceRotateServerCaCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> InstanceRotateServerCaCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> InstanceRotateServerCaCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceRotateServerCaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceRotateServerCaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
impl<'a, C, A> InstanceListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceListServerCaCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceListServerCaCall<'a, C, A> {}

impl<'a, C, A> InstanceListServerCaCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, InstancesListServerCasResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{ContentType, ContentLength, Authorization, Bearer, UserAgent, Location};
        let mut dd = DefaultDelegate;
        let mut dlg: &mut Delegate = match self._delegate {
        ...
        dlg.begin(MethodInfo { id: "sql.instances.listServerCas",
                               http_method: hyper::method::Method::Get });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> InstanceListServerCaCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> InstanceListServerCaCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> InstanceListServerCaCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceListServerCaCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceListServerCaCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceUpdateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceUpdateCall<'a, C, A> {}

impl<'a, C, A> InstanceUpdateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceUpdateCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceUpdateCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceRestartCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceRestartCall<'a, C, A> {}

impl<'a, C, A> InstanceRestartCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceRestartCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceRestartCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceExportCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceExportCall<'a, C, A> {}

impl<'a, C, A> InstanceExportCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceExportCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceExportCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct InstanceRestoreBackupCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for InstanceRestoreBackupCall<'a, C, A> {}

impl<'a, C, A> InstanceRestoreBackupCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> InstanceRestoreBackupCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> InstanceRestoreBackupCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
///              .database_version("rebum.")
///              .doit();
/// # }
/// ```
pub struct FlagListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for FlagListCall<'a, C, A> {}

impl<'a, C, A> FlagListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> FlagListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> FlagListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabaseDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabaseDeleteCall<'a, C, A> {}

impl<'a, C, A> DatabaseDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        }
        {
            ...
            for param_name in ["database", "instance", "project"].iter() {
                if let Some(index) = params.iter().position(|t| &t.0 == param_name) {
                    indices_for_removal.push(index);
                }
            }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabaseDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabaseDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabasePatchCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabasePatchCall<'a, C, A> {}

impl<'a, C, A> DatabasePatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabasePatchCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabasePatchCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabaseListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabaseListCall<'a, C, A> {}

impl<'a, C, A> DatabaseListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabaseListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabaseListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabaseInsertCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabaseInsertCall<'a, C, A> {}

impl<'a, C, A> DatabaseInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabaseInsertCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabaseInsertCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabaseGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabaseGetCall<'a, C, A> {}

impl<'a, C, A> DatabaseGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabaseGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabaseGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct DatabaseUpdateCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for DatabaseUpdateCall<'a, C, A> {}

impl<'a, C, A> DatabaseUpdateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> DatabaseUpdateCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> DatabaseUpdateCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct SslCertInsertCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for SslCertInsertCall<'a, C, A> {}

impl<'a, C, A> SslCertInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> SslCertInsertCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> SslCertInsertCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct SslCertDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for SslCertDeleteCall<'a, C, A> {}

impl<'a, C, A> SslCertDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(3);
            for param_name in ["sha1Fingerprint", "instance", "project"].iter() {
                if let Some(index) = params.iter().position(|t| &t.0 == param_name) {
                    indices_for_removal.push(index);
                }
            }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> SslCertDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> SslCertDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct SslCertGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for SslCertGetCall<'a, C, A> {}

impl<'a, C, A> SslCertGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> SslCertGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> SslCertGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct SslCertCreateEphemeralCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for SslCertCreateEphemeralCall<'a, C, A> {}

impl<'a, C, A> SslCertCreateEphemeralCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, SslCert)> {
        ...
        dlg.begin(MethodInfo { id: "sql.sslCerts.createEphemeral",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SslCertsCreateEphemeralRequest) -> SslCertCreateEphemeralCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Project ID of the Cloud SQL project.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> SslCertCreateEphemeralCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> SslCertCreateEphemeralCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> SslCertCreateEphemeralCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> SslCertCreateEphemeralCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> SslCertCreateEphemeralCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct SslCertListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for SslCertListCall<'a, C, A> {}

impl<'a, C, A> SslCertListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> SslCertListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> SslCertListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BackupRunListCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BackupRunListCall<'a, C, A> {}

impl<'a, C, A> BackupRunListCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> BackupRunListCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BackupRunListCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BackupRunGetCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BackupRunGetCall<'a, C, A> {}

impl<'a, C, A> BackupRunGetCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, BackupRun)> {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(3);
            for param_name in ["id", "instance", "project"].iter() {
                if let Some(index) = params.iter().position(|t| &t.0 == param_name) {
                    indices_for_removal.push(index);
                }
            }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> BackupRunGetCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BackupRunGetCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BackupRunDeleteCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BackupRunDeleteCall<'a, C, A> {}

impl<'a, C, A> BackupRunDeleteCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.backupRuns.delete",
                               http_method: hyper::method::Method::Delete });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> BackupRunDeleteCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> BackupRunDeleteCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> BackupRunDeleteCall<'a, C, A> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> BackupRunDeleteCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> BackupRunDeleteCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BackupRunDeleteCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// # }
/// ```
pub struct BackupRunInsertCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for BackupRunInsertCall<'a, C, A> {}

impl<'a, C, A> BackupRunInsertCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        dlg.begin(MethodInfo { id: "sql.backupRuns.insert",
                               http_method: hyper::method::Method::Post });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("project", self._project.to_string()));
        params.push(("instance", self._instance.to_string()));
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: BackupRun) -> BackupRunInsertCall<'a, C, A> {
        self._request = new_value;
        self
    }
    /// Project ID of the project that contains the instance.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project(mut self, new_value: &str) -> BackupRunInsertCall<'a, C, A> {
        self._project = new_value.to_string();
        self
    }
    /// Cloud SQL instance ID. This does not include the project ID.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn instance(mut self, new_value: &str) -> BackupRunInsertCall<'a, C, A> {
        self._instance = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> BackupRunInsertCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// req = req.header(header::Range::Bytes(vec![header::ByteRangeSpec::FromTo(10,20)]));
    /// ```
    pub fn header<H>(mut self, header: H) -> BackupRunInsertCall<'a, C, A>
                                                        where H: hyper::header::Header+hyper::header::HeaderFormat {
        self._additional_headers.set(header);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> BackupRunInsertCall<'a, C, A>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
