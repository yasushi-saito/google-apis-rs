...
//! This documentation was generated from *playcustomapp* crate version *1.0.12+20170622*, where *20170622* is the exact revision of the *playcustomapp:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.Playcustomapp.html) ... 
//! 
//! * accounts
//!  * [*custom apps create*](struct.AccountCustomAppCreateCall.html)
//! 
//! 
//! Upload supported by ...
//! 
//! * [*custom apps create accounts*](struct.AccountCustomAppCreateCall.html)
//! 
//! 
//! 
...
/// 
/// * [custom apps create accounts](struct.AccountCustomAppCreateCall.html) (request|response)
/// 
...
impl<'a, C, A> AccountMethods<'a, C, A> {
    ...
    pub fn custom_apps_create(&self, request: CustomApp, account: &str) -> AccountCustomAppCreateCall<'a, C, A> {
...
impl<'a, C, A> AccountCustomAppCreateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn request(mut self, new_value: CustomApp) -> AccountCustomAppCreateCall<'a, C, A> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn account(mut self, new_value: &str) -> AccountCustomAppCreateCall<'a, C, A> {
    ...
    pub fn delegate(mut self, new_value: &'a mut Delegate) -> AccountCustomAppCreateCall<'a, C, A> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> AccountCustomAppCreateCall<'a, C, A>
    ...
    pub fn add_scope<T, S>(mut self, scope: T) -> AccountCustomAppCreateCall<'a, C, A>
