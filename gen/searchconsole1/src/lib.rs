...
//! This documentation was generated from *Search Console* crate version *1.0.12+20190629*, where *20190629* is the exact revision of the *searchconsole:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/searchconsole1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](struct.SearchConsole.html) ... 
//! 
//! * url testing tools
//!  * [*mobile friendly test run*](struct.UrlTestingToolMobileFriendlyTestRunCall.html)
//! 
//! 
//! 
//! 
...
impl<'a, C, A> Hub for SearchConsole<C, A> {}

impl<'a, C, A> SearchConsole<C, A>
    where  C: BorrowMut<hyper::Client>, A: oauth2::GetToken {

    pub fn new(client: C, authenticator: A) -> SearchConsole<C, A> {
        SearchConsole {
    ...
    pub fn url_testing_tools(&'a self) -> UrlTestingToolMethods<'a, C, A> {
...
impl Part for MobileFriendlyIssue {}
...
/// 
/// * [mobile friendly test run url testing tools](struct.UrlTestingToolMobileFriendlyTestRunCall.html) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
impl RequestValue for RunMobileFriendlyTestRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [mobile friendly test run url testing tools](struct.UrlTestingToolMobileFriendlyTestRunCall.html) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// # }
/// ```
pub struct UrlTestingToolMethods<'a, C, A>
    where C: 'a, A: 'a {

    hub: &'a SearchConsole<C, A>,
}

impl<'a, C, A> MethodsBuilder for UrlTestingToolMethods<'a, C, A> {}

impl<'a, C, A> UrlTestingToolMethods<'a, C, A> {
    ...
    pub fn mobile_friendly_test_run(&self, request: RunMobileFriendlyTestRequest) -> UrlTestingToolMobileFriendlyTestRunCall<'a, C, A> {
...
/// # }
/// ```
pub struct UrlTestingToolMobileFriendlyTestRunCall<'a, C, A>
    where C: 'a, A: 'a {
...
impl<'a, C, A> CallBuilder for UrlTestingToolMobileFriendlyTestRunCall<'a, C, A> {}

impl<'a, C, A> UrlTestingToolMobileFriendlyTestRunCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {


    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, RunMobileFriendlyTestResponse)> {
    ...
    pub fn request(mut self, new_value: RunMobileFriendlyTestRequest) -> UrlTestingToolMobileFriendlyTestRunCall<'a, C, A> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> UrlTestingToolMobileFriendlyTestRunCall<'a, C, A>
                                                        where T: AsRef<str> {
    ...
    /// ```
    pub fn header<H>(mut self, header: H) -> UrlTestingToolMobileFriendlyTestRunCall<'a, C, A>
