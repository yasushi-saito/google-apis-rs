...
//! This documentation was generated from *Cloud RuntimeConfig* crate version *1.0.12+20190624*, where *20190624* is the exact revision of the *runtimeconfig:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
