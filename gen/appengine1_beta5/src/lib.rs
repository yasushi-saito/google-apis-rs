...
//! This documentation was generated from *appengine* crate version *1.0.12+20181005*, where *20181005* is the exact revision of the *appengine:v1beta5* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
//! Everything else about the *appengine* *v1_beta5* API can be found at the
//! [official documentation site](https://cloud.google.com/appengine/docs/admin-api/).
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/appengine1_beta5).
//! # Features
//! 
...
/// # extern crate yup_oauth2 as oauth2;
/// # extern crate google_appengine1_beta5 as appengine1_beta5;
/// use appengine1_beta5::Application;
/// # #[test] fn egal() {
/// # use std::default::Default;
/// # use oauth2::{Authenticator, DefaultAuthenticatorDelegate, ApplicationSecret, MemoryStorage};
/// # use appengine1_beta5::Appengine;
...
impl<'a, C, A> AppServiceVersionPatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *mask* query property to the given value.
    pub fn mask(mut self, new_value: &str) -> AppServiceVersionPatchCall<'a, C, A> {
        self._mask = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
impl<'a, C, A> AppServicePatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *mask* query property to the given value.
    pub fn mask(mut self, new_value: &str) -> AppServicePatchCall<'a, C, A> {
        self._mask = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
