...
//! This documentation was generated from *Deployment Manager* crate version *1.0.12+20160201*, where *20160201* is the exact revision of the *deploymentmanager:v2beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/master/gen/deploymentmanager2_beta2).
//! # Features
//! 
...
//!  * [*delete*](struct.DeploymentDeleteCall.html), [*get*](struct.DeploymentGetCall.html), [*insert*](struct.DeploymentInsertCall.html), [*list*](struct.DeploymentListCall.html), [*patch*](struct.DeploymentPatchCall.html) and [*update*](struct.DeploymentUpdateCall.html)
...
/// // Values shown here are possibly random and not representative !
/// let result = hub.deployments().update(req, "project", "deployment")
///              .update_policy("dolore")
///              .delete_policy("invidunt")
///              .create_policy("aliquyam")
///              .doit();
/// # }
/// ```
...
impl<'a, C, A> DeploymentUpdateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, Operation)> {
        ...
        params.push(("project", self._project.to_string()));
        params.push(("deployment", self._deployment.to_string()));
        if let Some(value) = self._update_policy {
            params.push(("updatePolicy", value.to_string()));
        }
    ...
    pub fn update_policy(mut self, new_value: &str) -> DeploymentUpdateCall<'a, C, A> {
...
impl<'a, C, A> DeploymentPatchCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    ///
    /// Sets the *update policy* query property to the given value.
    pub fn update_policy(mut self, new_value: &str) -> DeploymentPatchCall<'a, C, A> {
        self._update_policy = Some(new_value.to_string());
        self
    }
    /// Sets the policy to use for deleting resources.
