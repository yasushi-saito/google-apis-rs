...
//! This documentation was generated from *Surveys* crate version *1.0.12+20180508*, where *20180508* is the exact revision of the *surveys:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
