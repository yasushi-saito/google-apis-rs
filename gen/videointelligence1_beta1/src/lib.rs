...
//! This documentation was generated from *Cloud Video Intelligence* crate version *1.0.12+20171122*, where *20171122* is the exact revision of the *videointelligence:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.12*.
//! 
...
impl<'a, C, A> VideoMethods<'a, C, A> {
    ...
    pub fn annotate(&self, request: GoogleCloudVideointelligenceV1beta1_AnnotateVideoRequest) -> VideoAnnotateCall<'a, C, A> {
        VideoAnnotateCall {
            hub: self.hub,
            _request: request,
...
impl<'a, C, A> VideoAnnotateCall<'a, C, A> where C: BorrowMut<hyper::Client>, A: oauth2::GetToken {
    ...
    pub fn request(mut self, new_value: GoogleCloudVideointelligenceV1beta1_AnnotateVideoRequest) -> VideoAnnotateCall<'a, C, A> {
